				...
				)
{
	...
	float *alpha = new float[max_states];
	float *alpha_prime = new float[max_states];
	float *beta = new float[max_states*(LL+KK)];
	/* following has been changed on 3-14-06 */
	/* metric_c = calloc( number_symbols, sizeof(int) ); */
	float *metric_c = new float[number_symbols];
	float *rec_array = new float[nn];
	float *num_llr_c = new float[nn];
	float *den_llr_c = new float[nn];
